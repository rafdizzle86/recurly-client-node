...
class Client extends BaseClient {
   ...
   * List sites
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_sites}
   *
   ...
   * Fetch a site
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_site}
   *
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_accounts}
   *
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   *   commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.
   ...
   * Create an account
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/create_account}
   *
   ...
   * Fetch an account
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_account}
   *
   ...
   * Modify an account
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/update_account}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/deactivate_account}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   * @return {Promise<Account>} An account.
   */
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_account_acquisition}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/update_account_acquisition}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/remove_account_acquisition}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/reactivate_account}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   * @return {Promise<Account>} An account.
   */
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_account_balance}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_billing_info}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/update_billing_info}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/remove_billing_info}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_account_coupon_redemptions}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_active_coupon_redemption}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/create_coupon_redemption}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/remove_coupon_redemption}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_account_credit_payments}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {number} params.limit - Limit number of records 1-200.
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_account_invoices}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/create_invoice}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/preview_invoice}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   * @param {InvoiceCreate} body - The object representing the JSON request to send to the server. It should conform to the schema of {InvoiceCreate}
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_account_line_items}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/create_line_item}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_account_notes}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_account_note}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_shipping_addresses}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/create_shipping_address}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_shipping_address}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/update_shipping_address}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   * @param {string} shippingAddressId - Shipping Address ID.
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/remove_shipping_address}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   * @param {string} shippingAddressId - Shipping Address ID.
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_account_subscriptions}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_account_transactions}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_child_accounts}
   *
   * @param {string} accountId - Account ID or code (use prefix: `code-`, e.g. `code-bob`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_account_acquisition}
   *
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   *   commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_coupons}
   *
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   *   commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.
   ...
   * Create a new coupon
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/create_coupon}
   *
   ...
   * Fetch a coupon
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_coupon}
   *
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/update_coupon}
   *
   * @param {string} couponId - Coupon ID or code (use prefix: `code-`, e.g. `code-10off`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_unique_coupon_codes}
   *
   * @param {string} couponId - Coupon ID or code (use prefix: `code-`, e.g. `code-10off`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_credit_payments}
   *
   * @param {Object} params - The optional url parameters for this request.
   * @param {number} params.limit - Limit number of records 1-200.
   * @param {string} params.order - Sort order.
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_credit_payment}
   *
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_custom_field_definitions}
   *
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   *   commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_custom_field_definition}
   *
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_invoices}
   *
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   *   commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.
   ...
   * Fetch an invoice
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_invoice}
   *
   ...
   * Update an invoice
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/put_invoice}
   *
   * @param {string} invoiceId - Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/collect_invoice}
   *
   * @param {string} invoiceId - Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/fail_invoice}
   *
   * @param {string} invoiceId - Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).
   * @return {Promise<Invoice>} The updated invoice.
   */
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/mark_invoice_successful}
   *
   * @param {string} invoiceId - Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).
   * @return {Promise<Invoice>} The updated invoice.
   */
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/reopen_invoice}
   *
   * @param {string} invoiceId - Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).
   * @return {Promise<Invoice>} The updated invoice.
   */
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_invoice_line_items}
   *
   * @param {string} invoiceId - Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_invoice_coupon_redemptions}
   *
   * @param {string} invoiceId - Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_related_invoices}
   *
   * @param {string} invoiceId - Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).
   ...
   * Refund an invoice
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/refund_invoice}
   *
   * @param {string} invoiceId - Invoice ID or number (use prefix: `number-`, e.g. `number-1000`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_line_items}
   *
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   *   commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.
   ...
   * Fetch a line item
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_line_item}
   *
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/remove_line_item}
   *
   * @param {string} lineItemId - Line Item ID.
   ...
   * List a site's plans
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_plans}
   *
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   *   commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.
   ...
   * Create a plan
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/create_plan}
   *
   ...
   * Fetch a plan
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_plan}
   *
   ...
   * Update a plan
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/update_plan}
   *
   * @param {string} planId - Plan ID or code (use prefix: `code-`, e.g. `code-gold`).
   ...
   * Remove a plan
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/remove_plan}
   *
   * @param {string} planId - Plan ID or code (use prefix: `code-`, e.g. `code-gold`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_plan_add_ons}
   *
   * @param {string} planId - Plan ID or code (use prefix: `code-`, e.g. `code-gold`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   ...
   * Create an add-on
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/create_plan_add_on}
   *
   * @param {string} planId - Plan ID or code (use prefix: `code-`, e.g. `code-gold`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_plan_add_on}
   *
   * @param {string} planId - Plan ID or code (use prefix: `code-`, e.g. `code-gold`).
   ...
   * Update an add-on
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/update_plan_add_on}
   *
   * @param {string} planId - Plan ID or code (use prefix: `code-`, e.g. `code-gold`).
   * @param {string} addOnId - Add-on ID or code (use prefix: `code-`, e.g. `code-gold`).
   ...
   * Remove an add-on
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/remove_plan_add_on}
   *
   * @param {string} planId - Plan ID or code (use prefix: `code-`, e.g. `code-gold`).
   * @param {string} addOnId - Add-on ID or code (use prefix: `code-`, e.g. `code-gold`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_add_ons}
   *
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   *   commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.
   ...
   * Fetch an add-on
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_add_on}
   *
   * @param {string} addOnId - Add-on ID or code (use prefix: `code-`, e.g. `code-gold`).
   * @return {Promise<AddOn>} An add-on.
   */
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_shipping_methods}
   *
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   *   commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_shipping_method}
   *
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_subscriptions}
   *
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   *   commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/create_subscription}
   *
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_subscription}
   *
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/modify_subscription}
   *
   * @param {string} subscriptionId - Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/terminate_subscription}
   *
   * @param {string} subscriptionId - Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).
   * @param {Object} params - The optional url parameters for this request.
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/cancel_subscription}
   *
   * @param {string} subscriptionId - Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/reactivate_subscription}
   *
   * @param {string} subscriptionId - Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).
   ...
   * Pause subscription
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/pause_subscription}
   *
   * @param {string} subscriptionId - Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).
   ...
   * Resume subscription
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/resume_subscription}
   *
   * @param {string} subscriptionId - Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).
   * @return {Promise<Subscription>} A subscription.
   */
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_subscription_change}
   *
   * @param {string} subscriptionId - Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/create_subscription_change}
   *
   * @param {string} subscriptionId - Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/remove_subscription_change}
   *
   * @param {string} subscriptionId - Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_subscription_invoices}
   *
   * @param {string} subscriptionId - Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_subscription_line_items}
   *
   * @param {string} subscriptionId - Subscription ID or UUID (use prefix: `uuid-`, e.g. `uuid-123457890`).
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/list_transactions}
   *
   * @param {Object} params - The optional url parameters for this request.
   * @param {array} params.ids - Filter results by their IDs. Up to 200 IDs can be passed at once using
   *   commas as separators, e.g. `ids=h1at4d57xlmy,gyqgg0d3v9n1,jrsm5b4yefg6`.
   ...
   * Fetch a transaction
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_transaction}
   *
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/get_unique_coupon_code}
   *
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/deactivate_unique_coupon_code}
   *
   * @param {string} uniqueCouponCodeId - Unique Coupon Code ID or code (use prefix: `code-`, e.g. `code-abc-8dh2-def`).
   * @return {Promise<UniqueCouponCode>} A unique coupon code.
   */
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/reactivate_unique_coupon_code}
   *
   * @param {string} uniqueCouponCodeId - Unique Coupon Code ID or code (use prefix: `code-`, e.g. `code-abc-8dh2-def`).
   * @return {Promise<UniqueCouponCode>} A unique coupon code.
   */
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/create_purchase}
   *
   ...
   *
   * {@link https://partner-docs.recurly.com/v2019-01-08#operation/preview_purchase}
   *
   * @param {PurchaseCreate} body - The object representing the JSON request to send to the server. It should conform to the schema of {PurchaseCreate}
