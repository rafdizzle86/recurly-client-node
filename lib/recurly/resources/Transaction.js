 ...
 * @prop {string} invoiceId - If this transaction pays (`type=payment`) for or refunds (`type=refund`) an invoice, this will be the invoice's ID. It will be null for verification (`type=verify`) transactions.
 ...
 * @prop {Object} paymentMethod - Payment method (TODO: this overlaps with BillinInfo’s payment_method but only documents credit cards)
 ...
 * @prop {string} subscriptionId - If the transaction is charging or refunding for a subscription, this is its ID.
